...
//    writing variables that holds the oprerands and the they type of calculation
...
//
//
////        Variables to handle the input buttons
...
//        codes that perform operation buttons
        ...
        if (operand1 == null) {
            ...
            when (pendingoperations) {
                ...
                "/" -> operand1 = if (value == 0.0) {
                    Double.NaN     //attempting to divide by 0
                } else {
                    operand1!! / value
                }
